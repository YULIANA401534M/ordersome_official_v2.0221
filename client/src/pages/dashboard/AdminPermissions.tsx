...
const AVAILABLE_PERMISSIONS = ORDER_SOME_PERMISSIONS.map((id) => ({
  id,
  ...ORDER_SOME_PERMISSION_DEFINITIONS[id],
}));
...
export default function AdminPermissions() {
  ...
  const handleEditPermissions = (user: any) => {
    setEditingUser(user);
    setSelectedPermissions(normalizeOrderSomePermissions(user.permissions));
  };
  ...
  return (
    <AdminDashboardLayout>
      <div style={{ background: "var(--os-bg)", minHeight: "100vh", padding: 20 }} className="space-y-5">
        ...
        {/* Users Table */}
        <div style={{ background: "var(--os-surface)", border: "1px solid var(--os-border)", borderRadius: 10, overflowX: "auto" }}>
